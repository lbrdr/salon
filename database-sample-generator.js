function createSampleData(database) {
	...
	const customerNames = [
		...
		'John Maverick Dantes',
		'Joseph Pascual',
		'Kier Avelino',
		'Rio Robert Gutierrez',
		'Ernest Mataya Trillo',
		'Leslie Ann Rosales',
		'Alexene Rivera',
		'Kim Chloe Brillantes',
		'Franchesca Jane Curtis',
		'Lorenzo Locsin',
		'John Carlo Lustre',
		'Chevy Bernardo',
		'Cyrill Diaz',
		...
		'Daniella Ilacad',
		'Carla Rain Gonzales',
		'Louise Andrea Alonzo',
		'Jamie Charlie San Pedro',
		'Mary Gaby Alawi',
		'Charimel Ward',
		'Blanco Luis Mariano',
		'Trillo Man Pangilinan',
		'Francis Manabat',
		'Reinielle Gutierrez',
		'Jerard Marudo',
		'Jane Marivic Fedelin',
		'Jonie Arcilla',
		'Arnel Miguel',
		'Estrellita Santos',
		'Nyebes Bables'
